...
class NotificationController extends Controller
{
    ...
    public function emailSettingUpdate(Request $request)
    {
        $request->validate([
            ...
            'email_from.required' => ':attribute is required',
            'email_from.email' => ':attribute must be a valid email address',
        ]);
   ...
   public  function smsSetting(){
    ...
    public function smsSettingUpdate(Request $request){
        $request->validate([
            'sms_method' => 'required|in:clickatell,infobip,messageBird,nexmo,smsBroadcast,twilio,custom',
