...
@section('panel')
    <div class="row gy-4 mb-4 pb-4">
        ...
        <div class="col-xxl-3 col-xl-4 col-md-6">
            <a class="dashboard-widget--card position-relative" href="{{ route('admin.users.all', 'kyc_verified') }}">
                <div class="dashboard-widget__icon">
            ...
            <div class="btn--wrap d-flex flex-wrap justify-content-lg-end gap-3">
                <div class="filter--dropdown dropdown userActionDropdown">
                    ...
                    <ul class="dropdown-menu box--shadow1">
                        ...
                        <li>
                            <a class="dropdown-item bulk-action-btn" data-action="kyc_verified"
                                data-title="@lang('KYC Verified Users')" data-message="@lang('Are you sure you want to verify KYC the selected users?')"
                                href="javascript:void(0)">
