            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap justify-content-end mt-3">
                    <button class="btn btn--danger me-3 confirmationBtn"
                        ...
                        data-action="{{ route('admin.users.kyc.reject', $user->id) }}"><i class="fa-solid fa-ban"></i>@lang('Reject')</button>
                    <button class="btn btn--success confirmationBtn"
                        data-question="@lang('Are you sure to approve this documents?')"
                        data-action="{{ route('admin.users.kyc.approve', $user->id) }}"><i class="fa-solid fa-circle-check"></i>@lang('Approve')</button>
                </div>
                @endif
            </div>
        </div>
