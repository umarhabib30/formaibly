        ...
        <div class="row g-4 justify-content-center">
            <div class="col-xl-8">
                <div class="profile__wrap card p-4">
                    <form action="{{ route('user.store.plan.payment') }}" method="post">
                        @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="input--group">
                                            <input type="number" step="any" name="amount" class="form--control"
                                                value="{{ getAmount($plan->price) }}" autocomplete="off" readonly required>
                        ...
                        <div class="col-sm-12">
                            <div class="mt-2 preview-details d-none">
                                ...
                                <span>
                                    <span class="min fw-bold">0</span> {{ $general->cur_text }} -
                                    <span class="max fw-bold">0</span> {{ $general->cur_text }} ,
                                </span>
