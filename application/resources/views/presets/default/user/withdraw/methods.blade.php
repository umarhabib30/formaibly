                ...
                <div class="profile__wrap card p-4">
                    <form action="{{ route('user.withdraw.money') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form--control select-2" name="method_code" required>
        ...
        (function($) {
            ...
            $('select[name=method_code]').on('change', function() {
                ...
                if (resource.currency != '{{ $general->cur_text }}') {
                    var rateElement =
                        `<span>@lang('Conversion Rate')</span> <span class="fw--500">1 {{ __($general->cur_text) }} = <span class="rate">${rate}</span>  <span class="base-currency">${resource.currency}</span></span>`;
